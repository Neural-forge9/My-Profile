...
export default async function ProjectPage({
  ...
  return (
    <article className="min-h-screen">
            ...
            <div className="flex flex-wrap gap-0 pt-2">
              {project.stack.map((tech) => (
                <Badge
                  key={tech}
                  variant="outline"
                  className="border-border bg-transparent px-4 py-2 font-mono text-xs font-semibold uppercase tracking-[0.08em] text-foreground"
                >
                  {tech}
                </Badge>
              ))}
      ...
      <div className="editorial-container py-16 md:py-24">
        <div className="grid border border-border bg-border md:grid-cols-[minmax(0,1fr)_384px]">
          <div className="space-y-14 bg-background p-8 md:p-12">
          ...
          <aside className="space-y-10 border-t border-border bg-card p-8 md:border-l md:border-t-0 md:p-10">
            <section className="space-y-5">
